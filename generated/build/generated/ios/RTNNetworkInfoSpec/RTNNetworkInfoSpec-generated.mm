...
namespace facebook {
  namespace react {
    ...
    static facebook::jsi::Value __hostFunction_NativeNetworkInfoSpecJSI_getIsNetworkAvailable(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "getIsNetworkAvailable", @selector(getIsNetworkAvailable:reject:), args, count);
    }
    ...
    NativeNetworkInfoSpecJSI::NativeNetworkInfoSpecJSI(const ObjCTurboModule::InitParams &params)
      : ObjCTurboModule(params) {
        ...
        methodMap_["getIsNetworkAvailable"] = MethodMetadata {0, __hostFunction_NativeNetworkInfoSpecJSI_getIsNetworkAvailable};
