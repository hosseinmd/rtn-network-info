...
namespace facebook {
  namespace react {
    /**
     * ObjC++ class for module 'NativeNetworkInfo'
     */
    class JSI_EXPORT NativeNetworkInfoSpecJSI : public ObjCTurboModule {
    public:
      NativeNetworkInfoSpecJSI(const ObjCTurboModule::InitParams &params);
    };
  } // namespace react
} // namespace facebook
